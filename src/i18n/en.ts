export default {
  ...
  about: {
    ...
    privacy: 'Your data is stored only in your browser (localStorage) and never uploaded to any server.',
    stack: 'Stack · Vue 3 · Vite · TypeScript · Pinia · vue-i18n · PWA',
    features: ['Multiple lists', 'Recursive item / group nesting', 'Status grouping', 'Date & time', 'Drag to sort / Ctrl to merge', 'Undo / redo', 'Bilingual (zh / en)', 'Light / dark themes', 'Import / export'],
    author: 'Author',
    license: 'License',
  },
