export default {
  ...
  item: { name: 'Item name', description: 'Item description', new: 'New item', edit: 'Edit item', date: 'Date', time: 'Time', datePlaceholder: 'Select date', timePlaceholder: 'Select time' },
